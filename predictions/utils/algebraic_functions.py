...
def holt_win(data, forecast_length):
    seasonal_period = min(30, int(len(data) / 3))
    exp_fit = ExponentialSmoothing(data, seasonal_periods=seasonal_period, trend='add', seasonal='add',
